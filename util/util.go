...
func CompileProject() ([]byte, error) {
	...
	// mqsicreatebar := config.Project.Profiles.Profile.Properties.PathToMqsiProfileScript + "\\" + "mqsicreatebar"
	...
	//cmd := exec.Command(...*mqsiCreateBar)
	cmd := exec.Command(mqsiCreateBar.mqsi,
		mqsiCreateBar.dataOption,
		mqsiCreateBar.workspace,
		mqsiCreateBar.barfileOption,
		mqsiCreateBar.barfileName,
